...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        const response = await axios.get<AdminData>("https://localhost:7051/api/UpdateProfile/profile", {
          headers: {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      await axios.put(
        `https://localhost:7051/api/UpdateProfile/update-profile/${userId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUpdatePassword = async (e) => {
    ...
    try {
      await axios.put(
        `https://localhost:7051/api/UpdateProfile/update-password/${userId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,

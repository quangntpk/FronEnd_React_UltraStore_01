...
const Blogs = () => {
  ...
  const [maNguoiDung, setMaNguoiDung] = useState<string | null>(null); // Thêm state cho maNguoiDung
  ...
  useEffect(() => {
    const userId = localStorage.getItem("userId"); // Giả sử key là "userId"
    if (userId) {
  ...
  const createBlog = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/Blog/CreateBlog`, {
        ...
        body: JSON.stringify({
          maNguoiDung: maNguoiDung, // Lấy từ state
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/Blog/${editBlog.maBlog}`,
        {
          ...
          body: JSON.stringify({
            ...
            maNguoiDung: editBlog.maNguoiDung, // Giữ nguyên giá trị hiện tại
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  >
                    ...
                    <option value="h2">Tiêu Đề Chính</option>
                    <option value="h3">Tiêu Đề Phụ</option>
                    <option value="paragraph">Nội Dung</option>
                  </select>
                </div>
                <textarea
                  name="noiDung"
